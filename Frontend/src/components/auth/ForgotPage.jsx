      ...
      <Card className="w-full max-w-md relative">
        <CardContent className="flex flex-col items-center sm:text-center">
          {isMobile ? (
            ...
            <button
              onClick={handleBack}
              className="fixed top-12 left-1/2 ml-4 flex items-center justify-center w-8 h-8 rounded-full bg-black border-2 border-[#06b6d4] hover:bg-blue-500 text-[#06b6d4] hover:text-white transition-all z-50"
              aria-label="Go back"
            >
              <ArrowLeft size={20} />
            </button>
